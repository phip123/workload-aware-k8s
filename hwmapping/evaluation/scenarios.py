...
from ether.blocks.cells import FiberToExchange, IoTComputeBox, MobileConnection
from ether.cell import GeoCell, LANCell, counters, SharedLinkCell, UpDownLink
...
from hwmapping.evaluation.storage import bucket_names, data_items
...
class FasterMobileConnection(UpDownLink):
    ...
    def __init__(self, backhaul='internet') -> None:
        super().__init__(250, 250, backhaul, latency.mobile_isp)
